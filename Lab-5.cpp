...
{
    Student st[5];
    st[0].setInfo("Sabiha","23-01-1998", "1308013", 150, false);
    st[1].setInfo("Nabiha","24-3-1996", "1308010", 550, false);
    st[2].setInfo("Labiha","11-2-1997", "1308004", 1500, true);
    st[3].setInfo("Mabiha","2-8-1995", "1308018", 200, false);
    st[4].setInfo("Fabiha","12-12-1999", "1308025", 250, false);
